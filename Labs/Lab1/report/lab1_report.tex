  ...
  pagecommand={
    ...
    \begin{tikzpicture}[remember picture,overlay]
      \node[anchor=west,font=\sffamily\fontsize{11}{13}\selectfont]
        at ([xshift=81mm,yshift=121mm]current page.south west) {\StudentName};
      \node[anchor=west,font=\sffamily\fontsize{11}{13}\selectfont]
        at ([xshift=81mm,yshift=113mm]current page.south west) {\UoGID};
      \node[anchor=west,font=\sffamily\fontsize{11}{13}\selectfont]
        at ([xshift=81mm,yshift=105mm]current page.south west) {\UESTCID};
      \node[anchor=west,font=\sffamily\fontsize{11}{13}\selectfont]
        at ([xshift=81mm,yshift=97mm]current page.south west) {\ReportDate};
    \end{tikzpicture}
  }
]{../Lab1H-RTCSA_2026-2027.pdf}
...
which is non-zero, so \texttt{Pinx} is \texttt{true}. If the register value is \texttt{0x0400}, the AND result is zero and \texttt{Pinx} is \texttt{false}.
