...
The editable report source is in `report/lab1_report.tex`; edit the identity fields in `report/metadata.tex`. The compiled report is available at `report/lab1_report.pdf`.
